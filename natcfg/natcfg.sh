...
# wget -qO natcfg.sh https://cdn.jsdelivr.net/gh/xiong96gh/pic_bed/natcfg/natcfg.sh && bash natcfg.sh
...
echo
setupService(){
    wget -qO /usr/local/bin/dnat.sh https://cdn.jsdelivr.net/gh/xiong96gh/pic_bed/natcfg/dnat.sh||{
